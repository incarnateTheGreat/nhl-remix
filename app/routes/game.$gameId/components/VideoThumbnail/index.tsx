...
export default function VideoThumbnail({ videoId }: VideoThumbnailProps) {
  ...
  return (
    <>
      <button
        className="ml-2 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-black text-lg text-white transition-colors hover:bg-slate-800"
        onClick={() => {
          getData();
        }}
      >
